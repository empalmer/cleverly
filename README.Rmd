...
$Y$ is a data frame of 12 counts with a column of time and a column of individual. Z is a vector of binary external variables. This is the expected format of data input for this algorithm. Make sure your usage matches this format. 
